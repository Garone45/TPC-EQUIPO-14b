                        ...
                        <div class="overflow-x-auto">
                            <asp:GridView ID="gvDetalleCompra" runat="server" AutoGenerateColumns="false" GridLines="None"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="PRODUCTO">
                                        ...
                                        <ItemTemplate>
                                            <div class="pl-6 py-3">
                                                ...
                                                <p class="text-xs text-slate-400">SKU: <%# Eval("IDProducto") %></p> </div>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:BoundField DataField="PrecioCosto" HeaderText="COSTO" DataFormatString="{0:C}">
                    ...
                    <div class="sticky top-6 flex flex-col gap-6">
                        ...
                        <section class="rounded-2xl border border-slate-200 bg-white p-6 shadow-lg shadow-slate-200/50 dark:border-slate-800 dark:bg-slate-900 dark:shadow-none">
                            ...
                            <div class="mt-8 flex flex-col gap-3">
                                <asp:Button ID="btnGuardarCompra" runat="server" Text="Confirmar Compra" CssClass="w-full cursor-pointer rounded-xl bg-primary px-4 py-3.5 text-sm font-bold text-white shadow-lg shadow-primary/30 hover:bg-primary/90 hover:scale-[1.02] active:scale-95 transition-all" />
                                
                                <asp:Button ID="btnCancelar" runat="server" Text="Cancelar Operación" CssClass="w-full cursor-pointer rounded-xl border border-transparent px-4 py-3.5 text-sm font-bold text-slate-500 hover:bg-red-50 hover:text-red-600 transition-colors" />
                            </div>
                        </section>

                        <div class="rounded-xl bg-blue-50 p-4 border border-blue-100 dark:bg-slate-800/50 dark:border-slate-700">
                            <div class="flex gap-3">
                                <span class="material-symbols-outlined text-blue-500">info</span>
                                <div>
                                    <p class="text-sm font-bold text-blue-900 dark:text-blue-200">¿Ayuda?</p>
                                    <p class="text-xs text-blue-700 mt-1 dark:text-blue-300">Recuerda que al confirmar la compra, el stock se actualizará automáticamente en el inventario.</p>
                                </div>
                            </div>
                        </div>
