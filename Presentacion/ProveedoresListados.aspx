<%@ Page Title="Gestión de Proveedores" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProveedoresListados.aspx.cs" Inherits="Presentacion.ProveedoresListado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                ...
                <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700/60 overflow-hidden">
                    <div class="overflow-x-auto">
                        ...
                        <asp:GridView ID="gvProveedores" runat="server" 
                            ...
                            <Columns>
                                <asp:BoundField DataField="RazonSocial" HeaderText="Razón Social" HeaderStyle-CssClass="px-6 py-3" ItemStyle-CssClass="px-6 py-4 font-medium text-slate-900 dark:text-white whitespace-nowrap" />
                                <asp:BoundField DataField="Cuit" HeaderText="CUIT" HeaderStyle-CssClass="px-6 py-3" ItemStyle-CssClass="px-6 py-4" />
    ...
    <div class="modal-dialog modal-dialog-centered" style="max-width: 400px;">
        ...
        <div class="modal-content border-0 shadow-2xl overflow-hidden" 
            ...
            <div class="bg-primary text-white px-4 py-2 flex justify-between items-center">
                <span class="font-bold text-sm tracking-wide">BAJA DE PROVEEDOR</span>
            ...
            <div class="modal-body text-center pt-6 pb-4 px-4 bg-white dark:bg-slate-800">
                ...
                <p class="text-slate-500 text-sm mt-1 leading-snug">
                    El proveedor pasará a estado inactivo (baja lógica).
                </p>
            </div>
    ...
    <script type="text/javascript">
        function abrirModalEliminar(id) {
            var hf = document.getElementById('<%= hfIdProveedor.ClientID %>');
            if (hf) hf.value = id;
