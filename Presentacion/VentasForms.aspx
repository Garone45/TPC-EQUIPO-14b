                ...
                <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700/60 overflow-hidden">
                    <div class="overflow-x-auto">
                        ...
                        <asp:GridView ID="gvVentas" runat="server" 
                            ...
                            <Columns>
                                <asp:BoundField DataField="IDPedido" HeaderText="#" HeaderStyle-CssClass="px-6 py-3" ItemStyle-CssClass="px-6 py-4 font-medium text-slate-900 dark:text-white" />
                                ...
                                <asp:BoundField DataField="Estado" HeaderText="Estado" HeaderStyle-CssClass="px-6 py-3" ItemStyle-CssClass="px-6 py-4" />
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center py-4">
                        ...
                        <small class="text-muted">Esta acción podría no ser reversible.</small>
                    </div>
