...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="max-w-7xl mx-auto">
        ...
        <asp:UpdatePanel ID="updMarcas" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                                    ...
                                    <ItemTemplate>
                                        <div class="flex justify-center gap-2">
                                            ...
                                            <a href="javascript:void(0);" 
                                               onclick="abrirModalEliminar(<%# Eval("IDMarca") %>);"
    ...
    <div class="modal-dialog modal-dialog-centered" style="max-width: 400px;">
        ...
        <div class="modal-content border-0 shadow-2xl overflow-hidden" 
            ...
            <div class="bg-primary text-white px-4 py-2 flex justify-between items-center">
                <span class="font-bold text-sm tracking-wide">BAJA DE MARCA</span>
            ...
            <div class="modal-body text-center pt-6 pb-4 px-4 bg-white dark:bg-slate-800">
                <div class="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-full bg-blue-50 dark:bg-blue-900/20">
                    <span class="material-symbols-outlined text-3xl text-primary">label_off</span>
                </div>
                
                <h3 class="text-lg font-bold text-slate-800 dark:text-white">¿Eliminar Marca?</h3>
                <p class="text-slate-500 text-sm mt-1 leading-snug">
                    La marca pasará a estado inactivo (baja lógica).
                </p>
            </div>
    ...
    <script type="text/javascript">
            ...
            prm.add_endRequest(function (sender, args) {
                if (args.get_error() == null) {
                    ...
                    if (focusedControl) {
                        ...
                        var temp = focusedControl.value; focusedControl.value = ''; focusedControl.value = temp;
                    }
                }
            });
        }
        ...
        function abrirModalEliminar(id) {
            var hf = document.getElementById('<%= hfIdMarca.ClientID %>');
            if (hf) hf.value = id;
